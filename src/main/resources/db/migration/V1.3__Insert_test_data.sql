-- Users
-- Le mot de passe est "password" hashé avec pgcrypto directement
INSERT INTO users (id, username, email, password) VALUES ('11111111-1111-1111-1111-111111111111', 'Alice', 'alice@example.com', crypt('password', gen_salt('bf')));
INSERT INTO users (id, username, email, password) VALUES ('22222222-2222-2222-2222-222222222222', 'Bob', 'bob@example.com', crypt('password', gen_salt('bf')));
